	...
	sdl_surf(s), rtt_tex(0)
{
	...
	bits_per_pixel = SDL_BITSPERPIXEL(sdl_surf->format);
	bytes_per_pixel = SDL_BYTESPERPIXEL(sdl_surf->format);

	RenderSurface::format.s_bpp = bits_per_pixel;
	RenderSurface::format.s_bytes_per_pixel = bytes_per_pixel;
	RenderSurface::format.r_loss = SDL3_RLOSS(sdl_surf);
	RenderSurface::format.g_loss = SDL3_GLOSS(sdl_surf);
	RenderSurface::format.b_loss = SDL3_BLOSS(sdl_surf);
	RenderSurface::format.a_loss = SDL3_ALOSS(sdl_surf);
	...
	RenderSurface::format.r_shift = SDL3_RSHIFT(sdl_surf);
	RenderSurface::format.g_shift = SDL3_GSHIFT(sdl_surf);
	RenderSurface::format.b_shift = SDL3_BSHIFT(sdl_surf);
	RenderSurface::format.a_shift = SDL3_ASHIFT(sdl_surf);
	RenderSurface::format.r_mask = SDL3_RMASK(sdl_surf);
	RenderSurface::format.g_mask = SDL3_GMASK(sdl_surf);
	RenderSurface::format.b_mask = SDL3_BMASK(sdl_surf);
	RenderSurface::format.a_mask = SDL3_AMASK(sdl_surf);
