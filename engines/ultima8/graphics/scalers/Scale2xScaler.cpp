...
const char *Scale2xScaler::ScalerDesc() const { return "AdvMame Scale2x Scaler"; }
const char *Scale2xScaler::ScalerCopyright() const { return "Copyright (C) 2001, 2002, 2003, 2004 Andrea Mazzoleni"; }
