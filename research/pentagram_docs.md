# GitHub - pentagram-u8/pentagram: A reimplementation of the Ultima 8 game engine

**URL:** https://github.com/pentagram-u8/pentagram
...
Latest commit
DominusExult
Merge pull request #8 from DominusExult/skf_to_png
c87a67c
 · 
History
1,669 Commits
...
Fixed references to line[0] that were crashing on blank lines in ini …
	


convert
	
fixed the case that flexpack choked on small objects since the change…
...
Aseprite plugin working for normal shapes not yet for u8skf or Pentag…
...
Fix description of QuickLoad in control gump.
...
Fixed output path quoting in MSVC projects to allow for upgrades to V…
	


tools
	
The convert to U7 palette feature is now part of the Exult Aseprite p…
...
Wrong default key to enable ttf fixed
...
Fixed flexpack Windows build
	


README
	
Patch #3441247 adds CoreMIDI which enables the use of external MIDI d…
...
F4 : toogle fullscreen
F7 : Quicksave
F8 : Quickload

Debug keyboard commands
~, F5 : hides/restores console
...
5.2. - 30 October 2011
1.2. Advanced Configuration: added a lot of settings. 2.1. Movement: no more keypad movement and the not for Mac OS is no longer needed. 2.2. Keyboard commands: updated and split in default and debug keys. Moved the Building SVN section to the bottom.
...
5.7. - 22 May 2005
1.2. Advanced Configuration some more configurations added. 1.3. Optional MIDI settings for Linux added.
...
A reimplementation of the Ultima 8 game engine
...
wench Alexis Ryan
Kirben
DominusExult Dominik Reichardt
